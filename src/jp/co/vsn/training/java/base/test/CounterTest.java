...
public class CounterTest {
    ...
    public void testInc() {
        ...
        assertTrue("戻り値がnullです", c != null);
        assertTrue("別のCounterインスタンスが返却されています", c == counter);
    ...
    // おまけテストケース(課題の範囲外ですが、しっかりと細かいところまでテストしたい人は@Ignoreを削除してテストしてみてください。)
    @Ignore
    @Test
    public void testParseException04() {
        try {
            ...
            assertTrue(counter.getCount() != 30);
        }
    }    
}
